...
*Python es un lenguaje debilmente tipado, y sin declaración de tipo, tan solo se declara la variable con un valor de inicialización, es lo **unico necesario**.* Es un lenguaje orientado a Objetos (POO).
...
## 2.4 Variables tipo str (String) o Cadena de caracteres
...
## 2.5 Variables tipo Booleana (bool)
